...
The Power Systems Architecture Lab (PSAL), led by [Professor Thomas Morstyn](https://eng.ox.ac.uk/people/thomas-morstyn), is focused on addressing these challenges through computational research across power systems modelling, control, planning and market design. We create new algorithms, models, and software needed to coordinate complex, distributed, and uncertain power systems. 
Our group is based within the [Department of Engineering Science](https://eng.ox.ac.uk/) at the University of Oxford.
