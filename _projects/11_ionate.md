...
img: assets/img/projects/KTP_IONATE.png
...
<div style="text-align: center; margin-top: 2rem;">
   <img src="{{ '/assets/img/projects/KTP_IONATE_wide.png' | relative_url }}" alt="PSAL Oxford logo" style="max-width: 800px; width: 100%;">
 </div>
...
<ul>
    <li>A strategy for optimal coordiantion of HITs in distribution networks {% cite hayward2024coordination %} </li>
